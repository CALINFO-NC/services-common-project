...
then
    ...
    artifactory_deploy $TRAVIS_BUILD_DIR/common-test common-test-javadoc-resources.jar
    artifactory_deploy $TRAVIS_BUILD_DIR/common-test common-test-sources.jar
