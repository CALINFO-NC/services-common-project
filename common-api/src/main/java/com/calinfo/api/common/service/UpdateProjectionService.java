...
/**
 * La mise à jour prend en entrée un "{@link Dto}" et renvoi une "{@link com.calinfo.api.common.dto.Dto}"
 *
 ...
 */
public interface UpdateProjectionService<I extends Dto, O extends Dto, ID> {
