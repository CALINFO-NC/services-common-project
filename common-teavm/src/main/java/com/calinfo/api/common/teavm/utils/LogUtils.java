package com.calinfo.api.common.teavm.utils;
...
public class LogUtils {
    ...
    public static void trace(String msg){
        ...
        String logLevel = System.getProperty("calinfo.common.teavm.log.level");

        if (!StringUtils.isBlank(logLevel) && logLevel.trim().equals("trace")){
            System.out.println(String.format("CALINFO COMMON-TEAVM ANNOTATIONS : %s", msg));
        }
    }
